...
import { ArrowLeft, Zap, Mail, Lock, ArrowRight } from 'lucide-react';
      ...
      <div className="w-full max-w-md p-6 relative z-10">
        ...
        >
          <div className="w-20 h-20 bg-[#111] border border-white/10 rounded-2xl mx-auto mb-6 flex items-center justify-center relative overflow-hidden group">
            ...
            <Zap size={32} className="text-[#FF6A00] relative z-10" />
          </div>
          <h1 className="font-display text-4xl md:text-5xl uppercase tracking-tighter mb-2">
            System <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF6A00] to-[#FF2A00]">Login</span>
          </h1>
          <p className="text-gray-400 font-mono text-xs uppercase tracking-widest">
            Authenticate to access your garage
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-[#FF6A00]/30 rounded-tl-2xl pointer-events-none" />
          <div className="absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 border-[#FF6A00]/30 rounded-br-2xl pointer-events-none" />
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                <Link to="/reset-password" className="text-[10px] font-mono uppercase tracking-widest text-[#FF6A00] hover:text-white transition-colors">Forgot?</Link>
              </div>
              <div className="relative">
