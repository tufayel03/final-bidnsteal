...
export function AuctionDetailPage() {
  ...
  const handleAddToCart = () => {
    const auctionProduct = {
      id: parseInt(activeAuction.id.replace(/\D/g, '')) || Math.floor(Math.random() * 10000),
                  ...
                  <div className="flex flex-col gap-3 sm:gap-4 mt-1 sm:mt-2 relative z-10">
                    ...
                    >
                      <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <span className="font-bold text-white uppercase tracking-widest text-[10px] sm:text-xs">Buy It Now</span>
                      </div>
                    ...
                    {isWinner ? (
                      <div className="flex flex-col gap-2">
                        <button 
                          ...
                          className="w-full bg-[#FF6A00] text-white font-bold uppercase tracking-widest py-3 sm:py-4 rounded-lg hover:bg-[#FF6A00]/80 transition-colors flex items-center justify-center gap-2 text-xs sm:text-sm"
                        >
                          <ShoppingBag size={16} /> Checkout
                        </button>
                        <button 
                          onClick={handleAddToCart}
                          className="w-full bg-white/10 text-white font-bold uppercase tracking-widest py-3 sm:py-4 rounded-lg hover:bg-white/20 transition-colors flex items-center justify-center gap-2 text-xs sm:text-sm border border-white/10"
                        >
