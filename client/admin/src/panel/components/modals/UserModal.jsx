    ...
    return (
        <>
            {(details || userDetailsLoading) && (
                <AdminModalPortal>
                    <div className="admin-modal-overlay user-details-overlay" style={{ justifyContent: 'flex-end', padding: 0, zIndex: 1050 }} onClick={(event) => event.target === event.currentTarget && admin.closeUserDetails && admin.closeUserDetails()}>
                        <div className="user-details-drawer">
                            ...
                            <div className="admin-modal-body custom-scrollbar user-details-body">
                                {userDetailsLoading ? (
                            ...
                            <div className="admin-modal-foot user-details-foot">
                                <button onClick={() => admin.closeUserDetails && admin.closeUserDetails()} className="user-details-btn user-details-btn--secondary">Close</button>
                                <button
