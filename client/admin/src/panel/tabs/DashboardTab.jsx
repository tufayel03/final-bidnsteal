            ...
            <div className="overview-head">
                <div>
                    ...
                    <p style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        System status:
                        <span className="ok-text" style={{ display: 'flex', alignItems: 'center', gap: '6px', textShadow: '0 0 10px rgba(34,197,94,0.4)', fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
